   ...
   /* private val labelPlay: String by lazy {"play"}
    ...
    private val mMovieListener = object : MovieView.MovieListener() {
        ...
        override fun onMovieStarted() {
            ...
            // the video.
            /*updatePictureInPictureActions(R.mipmap.ic_launcher, labelPause,
        ...
        override fun onMovieStopped() {
            ...
            // to play the video.
          /*  updatePictureInPictureActions(R.mipmap.ic_launcher, labelPlay,
    ...
    internal fun updatePictureInPictureActions(@DrawableRes iconId: Int, title: String,
       ...
       /* val intent = PendingIntent.getBroadcast(this@MainActivity,
        ...
        actions.add(RemoteAction(
                Icon.createWithResource(this@MainActivity, R.mipmap.ic_launcher),
                "info", "info_description"),
                PendingIntent.getActivity(this@MainActivity, REQUEST_INFO,
                        Intent(Intent.ACTION_VIEW, Uri.parse("info_uri")),
                        0));
